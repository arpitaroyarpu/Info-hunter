    ...
    <section class="home-grid">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="box">
                    ...
                    <div class="flex-box">
                        ...
                        ?>
                        <a href="author_posts.php?author=<?= $fetch_authors['name']; ?>"
                            class="links"><?= $fetch_authors['name']; ?></a>
                        <?php
                            }
                        } else {
            ...
            <div class="box">
                <p>categories</p>
                <div class="flex-box">
                    <a href="category.php?category=City Corporation" class="links">City Corporation</a>
                    <a href="category.php?category=Citizen Engagement" class="links">Citizen Engagement</a>
                    <a href="category.php?category=City Planning" class="links">City Planning</a>
                    <a href="category.php?category=Historical Urban Evolution" class="links">Historical Urban
                        Evolution</a>
                    <a href="category.php?category=Safety and Security Updates" class="links">Safety and Security
                        Updates</a>
                    <a href="category.php?category=Health and Wellness Resources" class="links">Health and Wellness
                        Resources</a>
